...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MyFirstPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=MyFirstPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MyFirstPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MyFirstPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MyFirstPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=MyFirstPlugin installer\n"
